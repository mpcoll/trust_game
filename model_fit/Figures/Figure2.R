...
options(tikzMetricPackages = c("\\usepackage[utf8]{inputenc}",
    ...
    "\\usepackage{amssymb}"))
tikz("FinalFig2.tex", width = 5.5, height = 11, standAlone = TRUE,
...
layout(matrix( c( 1, 1, 3, 3, 6, 7, 9,9, 1, 1, 3, 3, 6, 7, 9, 9, 2, 2, 4, 5, 8, 8, 10, 11, 2, 2, 4, 5, 8, 8, 10, 11 ), 8 ,4 ))
...
0.3088,    0.3209,    0.3276),
 ...
 0.3251,    0.3278,    0.3144)),10,4)
	...
	main= "A)  Investment and Repayment Profile,  
 Real Subject Data ",  
	cex.main = 1.0, 
...
col = c("lightblue","blue", "coral", "red"),
	...
	bar=barplot(matrix(Value1,2,2), main = "B)   Investment Reproduction,    
Classic Model ",
	xaxt = 'n',
	 ylab = " ",
	...
	bar=barplot(matrix(Value1,2,2), main = "C)   Repayment Reproduction,    
 Classic Model ",
	xaxt = 'n',
	  ylab = " ",
	 cex.axis = 1, cex.lab = 1, cex.main =1.0,
...
0.2858,    0.3041,    0.3140)),10,2)
	...
	main= "D)     Reproduced Investor Trajectory,         
 Classic Model ",  
	cex.main = 1.0, 	
	yaxt = 't',
	xlab = ' ',#'At Step', 
...
c( 0,    0,    0,    0,    0,    0,    0,
 ...
 c( 0.1263,    0.1928,    0.1778,         0 ,   0.1676 ,   0.1857 ,        0,
   0.1660,    0.1662,    0.1571)),10,2)
	...
	matplot(array(c((1:10),(1:10)),10,2), array(c(Value5[,1], Value5[,2]),c(10,2)),
	main= "E)     Reproduced Trustee Trajectory,         
 Classic Model ",  
	cex.main = 1.0, 	
	yaxt = 't',
	xlab = ' ',
...
0.3333,    0.1667,    0.6667,    0.5000,    0.5000,    0.5000,    0.3333,    0.3333, 0.1667,    0.1667 ),10,3)
	...
	main = "F)  Irritable Investor experiencing Repair,
...
0.3333 ,   0.1667,         0 ,        0 ,        0 ,        0 ,        0 ,   0.3333,0.1667 ,        0
	...
	matplot(array(c((1:10),(1:10), (1:10)),10,3), 
	main = "G)  Irritable Investor experiencing Break,
   $\\zeta^I = 0.5, q^T(\\zeta^I)= 0$   ",
	...
	bar=barplot(matrix(Value1,2,2), main = "H)   Investment Reproduction,    
Full Model ",
	xaxt = 'n',
	 ylab = " ",
	 cex.axis = 1, cex.lab = 1, cex.main = 1.0,
	...
	bar=barplot(matrix(Value1,2,2), main = "I)   Repayment Reproduction,    
 Full Model ",
	#xlab = "Group",
	xaxt = 'n',
	  ylab = " ",
...
0.2182,    0.1519,    0.1296)),10,2)
	...
	matplot(array(c((1:10),(1:10)),10,2), array(c(Value5[,1], Value5[,2]),c(10,2)),
	main= "J)     Reproduced Investor Trajectory,         
Full Model ",  
	cex.main = 1.0, 	
	#axes = TRUE,
	yaxt = 't',
...
c( 0,    0,    0,    0,    0,    0,    0,
 ...
 c( 0.1375,    0.1757,    0.1679,         0,    0.1866,    0.1501,         0,
	...
	matplot(array(c((1:10),(1:10)),10,2), array(c(Value5[,1], Value5[,2]),c(10,2)),
	main= "K)     Reproduced Trustee Trajectory,         
 Full Model ",  
	cex.main = 1.0, 	
	#axes = TRUE,
	yaxt = 't',
