...
i=0
for i in {0..10}  # Will run part 0-20 in parrallel
do
   ./code/model_fit/fit_ipomcp /code/data/trust_data.bin /code/model_fit/outputs/trust_params_pair$i.bin 128 $i $((i+ 1)) &
done
...
# do
#    sleep 5 && ./code/model_fit/fit_ipomcp /code/data/trust_data.bin /code/model_fit/outputs/trust_params_pair$i.bin 128 $i $((i+ 1)) &
# done
...
# for i in {121..128}
# do
#    sleep 5 && ./code/model_fit/fit_ipomcp /code/data/trust_data.bin /code/outputs/trust_params_pair$i.bin 128 $i $((i+ 1)) &
# done
